...
rem   java -jar "%dirPath%"/lib/servicedesk-cli-7.8.0.jar --server https://my.examplegear.com --user automation --password automation %*

java -jar "%dirPath%"/lib/servicedesk-cli-7.8.0.jar %*
