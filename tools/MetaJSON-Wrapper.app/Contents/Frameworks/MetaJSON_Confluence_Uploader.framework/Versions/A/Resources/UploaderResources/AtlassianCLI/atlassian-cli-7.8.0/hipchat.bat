...
rem   java -jar "%dirPath%"/lib/hipchat-cli-7.8.0.jar --server http://my-server --autoWait --token X1Xt096Pb9wyEf3EOsKkhc91wJ4MYYP0FcRcDFrx %*

java -jar "%dirPath%"/lib/hipchat-cli-7.8.0.jar %*
